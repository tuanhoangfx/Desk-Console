import { ClipboardList, Camera, PlayCircle, CalendarClock, Settings2 } from "lucide-react";
import {
  HubLogButton,
  HubSidebarBrandIcon,
...
const NAV: NavItem[] = [
  ...
  { screen: "captures", label: "Captures", icon: Camera, iconTone: "sky" },
  { screen: "runners", label: "Runners", icon: PlayCircle, iconTone: "amber" },
  { screen: "tasks", label: "Tasks", icon: CalendarClock, iconTone: "indigo" },
